...
**Authoring status:** Days 1–54 authored (lessons + exercises + project, gate-green). Warmup + Section 1 + Section 2 + Section 3 complete; Section 4 (04_real_apps) in progress. Days 55–100 pending (next: Day 55 — Authentication).
