...
**Authoring status:** Days 1–48 authored (lessons + exercises + project, gate-green). Warmup + Section 1 + Section 2 complete. Days 36–48 complete. Days 49–100 pending (next: Day 49 — Model Evaluation).
