...
**Authoring status:** Days 1–25 authored (lessons + exercises + project, gate-green). Warmup + Section 1 complete. Section 2 in progress (Days 21–25 done). Days 26–100 pending.
