...
**Authoring status:** Days 1–31 authored (lessons + exercises + project, gate-green). Warmup + Section 1 complete. Section 2 in progress (Days 21–31 done). Days 32–100 pending.
