...
**Authoring status:** Days 1–43 authored (lessons + exercises + project, gate-green). Warmup + Section 1 + Section 2 complete. Days 36–43 complete. Days 44–100 pending (next: Day 44 — Databases in Python).
