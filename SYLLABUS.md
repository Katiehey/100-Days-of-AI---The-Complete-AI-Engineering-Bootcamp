...
**Authoring status:** Days 1–32 authored (lessons + exercises + project, gate-green). Warmup + Section 1 complete. Section 2 in progress (Days 21–32 done). Days 33–100 pending.
