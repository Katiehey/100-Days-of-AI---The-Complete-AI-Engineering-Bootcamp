...
**Authoring status:** Days 1–22 authored (lessons + exercises + project, gate-green). Warmup + Section 1 complete. Section 2 in progress (Days 21–22 done). Days 23–100 pending.
