...
**Authoring status:** Days 1–37 authored (lessons + exercises + project, gate-green). Warmup + Section 1 + Section 2 complete. Days 36–37 complete. Days 38–100 pending (next: Day 38 — Exploratory Data Analysis).
