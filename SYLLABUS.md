...
**Authoring status:** Days 1–30 authored (lessons + exercises + project, gate-green). Warmup + Section 1 complete. Section 2 in progress (Days 21–30 done). Days 31–100 pending.
