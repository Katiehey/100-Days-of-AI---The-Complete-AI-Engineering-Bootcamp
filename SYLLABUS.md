...
**Authoring status:** Days 1–26 authored (lessons + exercises + project, gate-green). Warmup + Section 1 complete. Section 2 in progress (Days 21–26 done). Days 27–100 pending.
