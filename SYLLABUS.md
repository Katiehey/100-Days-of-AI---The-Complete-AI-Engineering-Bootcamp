...
**Authoring status:** Days 1–39 authored (lessons + exercises + project, gate-green). Warmup + Section 1 + Section 2 complete. Days 36–39 complete. Days 40–100 pending (next: Day 40 — AI-Assisted Analysis).
