...
**Authoring status:** Days 1–33 authored (lessons + exercises + project, gate-green). Warmup + Section 1 complete. Section 2 in progress (Days 21–33 done). Days 34–100 pending.
