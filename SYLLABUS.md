...
**Authoring status:** Days 1–36 authored (lessons + exercises + project, gate-green). Warmup + Section 1 + Section 2 complete. Day 36 complete. Days 37–100 pending (next: Day 37 — Data Cleaning).
