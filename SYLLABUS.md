...
**Authoring status:** Days 1–21 authored (lessons + exercises + project, gate-green). Warmup + Section 1 complete. Section 2 in progress (Day 21 done). Days 22–100 pending.
