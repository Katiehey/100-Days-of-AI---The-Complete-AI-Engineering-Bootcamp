...
**Authoring status:** Days 1–34 authored (lessons + exercises + project, gate-green). Warmup + Section 1 complete. Section 2 in progress (Days 21–34 done). Days 35–100 pending.
