...
**Authoring status:** Days 1–35 authored (lessons + exercises + project, gate-green). Warmup + Section 1 + Section 2 complete. Days 36–100 pending (next: Section 3 — Data &amp; Analysis).
