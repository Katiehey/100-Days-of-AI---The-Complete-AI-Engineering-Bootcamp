...
**Authoring status:** Days 1–29 authored (lessons + exercises + project, gate-green). Warmup + Section 1 complete. Section 2 in progress (Days 21–29 done). Days 30–100 pending.
