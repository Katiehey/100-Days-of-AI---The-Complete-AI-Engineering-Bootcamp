...
**Authoring status:** Days 1–41 authored (lessons + exercises + project, gate-green). Warmup + Section 1 + Section 2 complete. Days 36–41 complete. Days 42–100 pending (next: Day 42 — SQL Fundamentals).
