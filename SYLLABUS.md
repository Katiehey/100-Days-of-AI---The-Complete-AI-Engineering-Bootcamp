...
**Authoring status:** Days 1–47 authored (lessons + exercises + project, gate-green). Warmup + Section 1 + Section 2 complete. Days 36–47 complete. Days 48–100 pending (next: Day 48 — Feature Engineering & Intro ML).
