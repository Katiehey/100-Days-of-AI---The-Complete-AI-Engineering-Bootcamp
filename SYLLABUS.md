...
**Authoring status:** Days 1–42 authored (lessons + exercises + project, gate-green). Warmup + Section 1 + Section 2 complete. Days 36–42 complete. Days 43–100 pending (next: Day 43 — Natural Language → SQL).
