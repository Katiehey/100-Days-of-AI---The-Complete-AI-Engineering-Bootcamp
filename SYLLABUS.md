...
**Authoring status:** Days 1–24 authored (lessons + exercises + project, gate-green). Warmup + Section 1 complete. Section 2 in progress (Days 21–24 done). Days 25–100 pending.
