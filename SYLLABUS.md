...
**Authoring status:** Days 1–67 authored (lessons + exercises + project, gate-green). Warmup + Sections 1–4 complete. Days 66–67 (Images in Python, Vision LLM) complete. Days 68–100 pending (next: Day 68 — OCR & Document AI).
