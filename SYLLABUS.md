...
**Authoring status:** Days 1–38 authored (lessons + exercises + project, gate-green). Warmup + Section 1 + Section 2 complete. Days 36–38 complete. Days 39–100 pending (next: Day 39 — Data Visualization).
