...
**Authoring status:** Days 1–95 authored (lessons + exercises + project, gate-green). Warmup + Sections 1–6 complete. Section 6 (AI Agents, Days 79–88) complete. Days 89–95 gate-green; Section 7 in progress. Days 96–100 pending (next: Day 96 — The Trading Bot II).
