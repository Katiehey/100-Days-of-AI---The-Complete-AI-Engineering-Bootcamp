...
**Authoring status:** Days 1–49 authored (lessons + exercises + project, gate-green). Warmup + Section 1 + Section 2 complete. Days 36–49 complete. Days 50–100 pending (next: Day 50 — Capstone: Insight Engine).
