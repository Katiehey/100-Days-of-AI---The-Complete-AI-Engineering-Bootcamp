...
**Authoring status:** Days 1–23 authored (lessons + exercises + project, gate-green). Warmup + Section 1 complete. Section 2 in progress (Days 21–23 done). Days 24–100 pending.
