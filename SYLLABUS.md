...
**Authoring status:** Days 1–46 authored (lessons + exercises + project, gate-green). Warmup + Section 1 + Section 2 complete. Days 36–46 complete. Days 47–100 pending (next: Day 47 — Statistics for AI Engineers).
