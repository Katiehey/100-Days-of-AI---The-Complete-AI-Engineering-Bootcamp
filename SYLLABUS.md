...
**Authoring status:** Days 1–40 authored (lessons + exercises + project, gate-green). Warmup + Section 1 + Section 2 complete. Days 36–40 complete. Days 41–100 pending (next: Day 41 — Natural Language → Pandas).
